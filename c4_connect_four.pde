...
void C4_win() {
  ...
  for (int a=0; a<=6; a++) {
    for (int b=0; b<=3; b++) {
      ...
      if (board[a][b]==board[a][b+1]&&board[a][b]==board[a][b+3]&&board[a][b]==board[a][b+3]&&board[a][b]==2) {
        player2win=true;
      }
    }
  }
  for (int a=0; a<=3; a++) {
    for (int b=0; b<=3; b++) {
      ...
      if (board[a][b]==board[a+1][b+1]&&board[a][b]==board[a+2][b+3]&&board[a][b]==board[a+3][b+3]&&board[a][b]==2) {
        player2win=true;
      }
    }
  }
